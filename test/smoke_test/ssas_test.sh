...
ACO_ID=$(docker exec -it bcda-app_api_1 sh -c 'tmp/bcda create-aco --name="Smoke Test ACO" --cms-id=A9996 --group-id="smoke-test-group" --key-file=/go/src/github.com/CMSgov/bcda-app/shared_files/ATO_public.pem' | tail -n1)
echo "- ACO ID: $ACO_ID"
