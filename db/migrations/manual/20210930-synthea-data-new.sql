...
BEGIN
INSERT INTO cclf_files (created_at, updated_at, cclf_num, name, aco_cms_id, timestamp, performance_year, import_status, type) VALUES (now(), now(), 8, 'T.BCD.A9989.ZC8Y44.D210701.T1834180', 'A9989', '2021-07-01', 21, 'Completed', 0) RETURNING id INTO Dev;
INSERT INTO cclf_files (created_at, updated_at, cclf_num, name, aco_cms_id, timestamp, performance_year, import_status, type) VALUES (now(), now(), 8, 'T.BCD.A9998.ZC8Y20.D210701.T1834180', 'A9998', '2021-07-01', 21, 'Completed', 0) RETURNING id INTO Small;
