...
func (importer OptOutImporter) ImportSuppressionDirectory() (success, failure, skipped int, err error) {
	...
	err = importer.FileHandler.CleanupSuppression(suppresslist)
	if err != nil {
...
func (importer OptOutImporter) validate(metadata *SuppressionFileMetadata) error {
...
func (importer OptOutImporter) ImportSuppressionData(metadata *SuppressionFileMetadata) error {
	err := importer.importSuppressionMetadata(metadata, func(fileID uint, b []byte) error {
		suppression, err := ParseSuppressionLine(metadata, b)
		...
		if err = importer.Saver.SaveSuppression(*suppression); err != nil {
...
func (importer OptOutImporter) importSuppressionMetadata(metadata *SuppressionFileMetadata, importFunc func(uint, []byte) error) error {
