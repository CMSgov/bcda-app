...
func TestSetAppropriateServiceDateParams(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			params:       url.Values{"service-date": []string{"gt2022-01-01", "ge2023-02-02", "gt2024-03-03", "le2022-01-01", "lt2023-02-02", "le2024-03-03"}},
			expectedVals: []string{"gt2024-03-03", "le2022-01-01"},
		},
		{
			name:         "Multiple lower bounds set",
			params:       url.Values{"service-date": []string{"gt2022-01-01", "ge2023-02-02", "gt2024-03-03"}},
			expectedVals: []string{"gt2024-03-03"},
		},
		{
			name:         "Multiple upper bounds set",
			params:       url.Values{"service-date": []string{"le2022-01-01", "lt2023-02-02", "le2024-03-03"}},
