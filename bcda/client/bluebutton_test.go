...
func (s *BBTestSuite) SetupTest() {
	...
	os.Setenv("BB_CLIENT_CERT_FILE", "bb-dev-test-cert.pem")
	os.Setenv("BB_CLIENT_KEY_FILE", "bb-dev-test-key.pem")
	os.Setenv("BB_CLIENT_CA_FILE", "test-server-cert.pem")
