...
type suppressionRepository interface {
	...
	CreateSuppression(ctx context.Context, suppression suppression_utils.Suppression) error
}

type suppressionFileRepository interface {
	CreateSuppressionFile(ctx context.Context, suppressionFile suppression_utils.SuppressionFile) (uint, error)
