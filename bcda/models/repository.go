...
type suppressionRepository interface {
	...
	CreateSuppression(ctx context.Context, suppression optout.Suppression) error
}

type suppressionFileRepository interface {
	CreateSuppressionFile(ctx context.Context, suppressionFile optout.SuppressionFile) (uint, error)
