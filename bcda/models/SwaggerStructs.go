...
type SinceParam struct {
        // (Optional) Only include resource versions that were created at or after the given instant in time.  Format of string must align with the FHIR dateTime datatype.
        // in: query
        // required: false
