...
func (s *ResourcesTestSuite) TestSupportsDataType() {
	tests := []struct {
	...
	}{
		{
			...
			DataType{Adjudicated: true, PreAdjudicated: false, PartAdjudicated: false},
			constants.Adjudicated,
			true,
		},
		{
			"Valid Part-Adjudicated Type",
			DataType{Adjudicated: false, PreAdjudicated: true, PartAdjudicated: true},
			constants.PreAdjudicated,
			true,
		},
		{
			"Invalid Type",
			DataType{Adjudicated: true, PreAdjudicated: true, PartAdjudicated: true},
			"invalid-type",
			false,
		},
		{
			"Invalid Part-Adjudicated Type",
			DataType{Adjudicated: true, PreAdjudicated: false, PartAdjudicated: false},
			constants.PreAdjudicated,
			false,
		},
