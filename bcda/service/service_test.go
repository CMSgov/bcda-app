...
func (s *ServiceTestSuite) TestGetQueJobsByDataType() {
	...
	defaultACO := ACOConfig{
		patternExp: regexp.MustCompile(defaultACOID),
		Data:       []string{constants.Adjudicated, constants.PartAdjudicated},
	}
	...
	tests := []struct {
		...
		{"PartAdjudicated", defaultACOID, DefaultRequest, time.Time{}, claimsWindow{}, benes1, timeA, []string{"Claim"}, nil},
	}
