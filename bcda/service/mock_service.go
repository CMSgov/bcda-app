...
func (_m *MockService) GetAlrJobs(ctx context.Context, alrMBI *models.AlrMBIs) []*models.JobAlrEnqueueArgs {
	ret := _m.Called(ctx, alrMBI)

	var r0 []*models.JobAlrEnqueueArgs
	if rf, ok := ret.Get(0).(func(context.Context, *models.AlrMBIs) []*models.JobAlrEnqueueArgs); ok {
		r0 = rf(ctx, alrMBI)
	} else {
		if ret.Get(0) != nil {
...
func (_m *MockService) GetJobs(ctx context.Context, acoID uuid.UUID, statuses ...models.JobStatus) ([]*models.Job, error) {
	...
	var r0 []*models.Job
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, ...models.JobStatus) []*models.Job); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, uuid.UUID, ...models.JobStatus) error); ok {
