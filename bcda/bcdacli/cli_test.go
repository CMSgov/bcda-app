...
func (s *CLITestSuite) TestImportCCLFDirectory() {
	...
	tests := []test{
		{path: "../../shared_files/cclf/archives/valid/", err: errors.New("Files skipped or failed import. See logs for more details."), expectedLogs: []string{"Successfully imported 2 files.", "Failed to import 0 files.", "Skipped 1 files."}},
