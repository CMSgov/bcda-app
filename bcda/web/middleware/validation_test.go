...
func TestValidateTypeFilterTagCodes(t *testing.T) {
	...
	tests := []struct {
		...
		errMsg             string
		description        string
		expectedTypeFilter typefilter.Subquery // when non-nil, we assert the parsed TypeFilter in context equals this making sure params are not dropped.
	}{
		{
			...
			expectedTypeFilter: typefilter.Subquery{
