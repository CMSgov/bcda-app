...
func (s *OptOutTestSuite) TestParseMetadata_InvalidData() {
	...
	assert.EqualError(err, "failed to parse date 'D190117.T990942' from file: /path/T#EFT.ON.ACO.NGD1800.DPRF.D190117.T9909420, err: parsing time \"D190117.T990942\": hour out of range")
}
