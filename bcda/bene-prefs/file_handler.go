...
// File handlers can load bene-prefs files from a given source and can optionally clean them up afterwards.
...
type BenePrefsFileHandler interface {
	// Load bene-prefs files from the given path.
	//
	...
	// Cleanup any bene-prefs files that were successfully imported, and handle
	...
	// Open a given bene-prefs file, specified by the metadata struct.
