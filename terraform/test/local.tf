locals {
  ...
  ssas_certificate_arn  = "arn:aws:acm:${data.aws_region.current.name}:${data.aws_caller_identity.current.account_id}:certificate/a594ab60-0968-4ed8-84a8-5541afec8f47"
  ...
  # S3 related
  aco_credentials_bucket = "bcda-aco-credentials"
  ...
  ecs_task_def_cpu_worker = 1024
  ecs_task_def_mem_worker = 2048
